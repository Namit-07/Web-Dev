    ...
    <section className="bg-[#d2e823] min-h-[100vh] grid grid-cols-2">
      <div className="flex justify-center flex-col ml-[10vw] my-70">
        ...
        <div className="input flex gap-2">
          <input className="bg-white rounded-md py-5 px-8 font-bold text-left" type="text" placeholder="linktr.ee/" />
          <button className="text-white bg-[#254f1a] py-5 px-14 rounded-full font-bold whitespace-nowrap">Get Started for free</button>
        </div>
      </div>
