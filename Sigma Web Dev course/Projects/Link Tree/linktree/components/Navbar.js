...
const Navbar = () => {
  return (
    <nav className='bg-white w-[90vw] flex justify-between absolute top-12 right-[5vw] rounded-full p-4  '>
      ...
      <div className='flex gap-3'>
        <button className='login bg-gray-200 px-5 py-4 rounded-md font-bold'>Log in</button>
